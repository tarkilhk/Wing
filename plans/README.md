...
| --- | --- | --- | --- | --- |
| [003: Administration experience](003-administration-experience.md) | P1 | L | Completed voice/project work | DONE — full host suite, renders, native acceptance and debug build |
