...
For general privacy questions, contact the maintainer through [this fork's GitHub issues](https://github.com/tarkilhk/hermes-android/issues). Do not post passwords, private server addresses, personal files or conversation contents publicly. Ask for a private contact route before sharing sensitive details.
