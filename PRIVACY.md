...
This policy covers Wing, previously labelled Hermes Personal, maintained in the `tarkilhk/wing` repository. It is an independent Android client for a Hermes server you choose. The app does not require an account with this fork's maintainer. Your Hermes host, model providers, and services used by your agent have their own data practices.
